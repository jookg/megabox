              ...
              +' <div tabindex="0" class="contents">'
                ...
                +' <div class="movie_body movie">'
                  ...
                  +' <ul class="movie_list" id="selectMovieList">'
                    +' <li data-movietitle="범죄도시"><a title="범죄도시 선택" href="javascript:void(0);"><span class="blind">범죄도시</span></a>'
                    +' <div class="poster">'
                        +' <img alt="범죄도시" src="http://image2.megabox.co.kr/mop/poster/2017/46/F8B4A0-0392-4366-8344-9F210B198398.medium.jpg">'
                      +' </div>'
                      +' <p title="범죄도시" class="title">'
                        +' <span class="age age_19">청소년관람불가</span><span>범죄도시</span>'
                      +' </p></li>'
                    +' <li data-movietitle="그것"><a'
                      +' title="그것 선택" href="javascript:void(0);"><span'
...
reservation.event=(()=>{
	var init=function(){
		...
		$('#btnCinemaConfirm').click(()=> {
			...
			var ui = '<li data-slide-indicator="16" onclick="reservation.event.reservation_move()">'
				+' <div class="viewing_time"><p class="time_table"><strong>16:15</strong><span>~ 18:40</span></p></div>'
				+' <div class="movie"><p title="그것" class="title"><span class="age age_15">15세관람가</span>'
				+' <a title="2017-10-18 16:15 그것 선택" href="javascript:void(0);">그것</a></p>'
				+' <p class="subtitle">디지털(자막)</p></div><div class="theater_wrap"><p class="theater">강남<br>5관</p><p class="seat">87 / 92</p></div></li>';
			$('#movieTimeList').empty();
